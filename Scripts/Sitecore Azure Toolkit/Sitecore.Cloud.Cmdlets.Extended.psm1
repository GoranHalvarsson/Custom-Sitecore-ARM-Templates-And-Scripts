...
Function Start-SitecoreAzureDeployment{
    ...
    try {
        ...
        Set-SCAzureDeployModulesParameters -ParamJsonFile $paramJsonFile -Redeploy $Redeploy
...
Function Set-SCAzureDeployModulesParameters{
    ...
    try {
        ...
        $newData.parameters.modules.value.items[1].templateLink = $params.$("psTemplateLink").value
        $newData.parameters.modules.value.items[1].parameters.cmPsModuleMsDeployPackageUrl = $params.$("cmPsModuleMsDeployPackageUrl").value
        $newData.parameters.modules.value.items[1].parameters.cdPsModuleMsDeployPackageUrl = $params.$("cdPsModuleMsDeployPackageUrl").value
        $newData.parameters.modules.value.items[1].parameters.templateLinkAccessToken = $params.$("modulesTemplateLinkAccessToken").value
        
        $newData.parameters.modules.value.items[1].parameters.psMsDeployPackageUrl = $params.$("psMsDeployPackageUrl").value
        
        $newData.parameters.modules.value.items[2].templateLink = $params.$("azureblobstorageTemplateLink").value
        $newData.parameters.modules.value.items[2].parameters.blobStorageMsDeployPackageUrl = $params.$("blobStorageMsDeployPackageUrl").value
        $newData.parameters.modules.value.items[2].parameters.templateLinkAccessToken = $params.$("modulesTemplateLinkAccessToken").value
        
        $newData.parameters.modules.value.items[3].templateLink = $params.$("bootloaderTemplateLink").value
        $newData.parameters.modules.value.items[3].parameters.msDeployPackageUrl = $params.$("bootloaderMsDeployPackageUrl").value
        $newData.parameters.modules.value.items[3].parameters.templateLinkAccessToken = $params.$("modulesTemplateLinkAccessToken").value
...
# MTkxMTI1MTEzMjAxWjAjBgkqhkiG9w0BCQQxFgQUXI037mY2+qul9dYCmyNVAYvt
# vjIwDQYJKoZIhvcNAQEBBQAEggEAaFANnsDopWm0Orkc1uVmR4U2hCsYfq9pUGrv
# VIR4IdJAW7Z5+dOcxL3NTbdWiM3u21ZDJ2jidY/LKDDxbeSi/pVFTH1VAUfpOfbZ
# WXXGvM4i4iFl0jn6HY7iZ75aQpYpzcrq9Z4+81fizt0lsOHR522XykxSAV0bdGv8
# 7Iuh6fUCL47KAFn96T2jCzGX/zyZiLdF0Vo9LuMQmomNXh0PyD5q9uYpnG3cDjR6
# b/K/cpkddWt+7131ot/YEOeyKujozffhGM20xyA00ok02Md72kwrhZ1c9tB5vcSo
# LNdhRTUhczCL4A10DFw9nM31S7GLfyYPS5TOs+a3WpNfVv/epg==
